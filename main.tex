...
\noindent\adjustbox{bgcolor=blue!20,minipage=[t]{\linewidth}}{
...
\noindent\adjustbox{bgcolor=\highlightstatelements,minipage=[t]{\linewidth}}{
\subsection{\colorbox{registers}{Registers} } retain state until updated \newline
...
\subsection{\colorbox{readwritemem}{Read-Write Memory} } provide addressable memories \newline
...
\noindent\adjustbox{bgcolor=\highlighthardware,minipage=[t]{\linewidth}}{
...
\noindent\adjustbox{bgcolor=\highlightbundle,minipage=[t]{\linewidth}}{
\subsection{\colorbox{bundle}{Bundle} } contains \verb$Data$ types indexed by name
...
\noindent\adjustbox{bgcolor=\highlightvec,minipage=[t]{\linewidth}}{
\subsection{\colorbox{vec}{Vec} } is an indexable vector of \verb$Data$ types
\begin{scala}
...
\noindent\adjustbox{bgcolor=\highlightstateless,minipage=[t]{\linewidth}}{
\subsection{\colorbox{stateless}{Stateless}}: \newline
...
\noindent\adjustbox{bgcolor=\highlightstateful,minipage=[t]{\linewidth}}{
\subsection{\colorbox{stateful}{Stateful}}: \newline
...
\noindent\adjustbox{bgcolor=\highlightdecoupledio,minipage=[t]{\linewidth}}{
\subsection{\colorbox{decoupledio}{DecoupledIO} } \mbox{is a \texttt{Bundle} with a ready-valid interface}
...
\noindent\adjustbox{bgcolor=\highlightvalidio,minipage=[t]{\linewidth}}{
\subsection{\colorbox{validio}{ValidIO} } is a \verb$Bundle$ with a valid interface
\subsubsection{Constructor}: \newline
\verb$Valid(gen:Data)$ \newline
\begin{tabular}{l l l}
...
\noindent\adjustbox{bgcolor=\highlightqueue,minipage=[t]{\linewidth}}{
\subsection{\colorbox{queue}{Queue} } is a \verb$Module$ providing a hardware queue
\subsubsection{Constructor}: \newline
...
\noindent\adjustbox{bgcolor=\highlightpipe,minipage=[t]{\linewidth}}{
\subsection{\colorbox{pipe}{Pipe} }is a \verb$Module$ delaying input data
\subsubsection{Constructor}: \newline
...
\noindent\adjustbox{bgcolor=\highlightarbiters,minipage=[t]{\linewidth}}{
\subsection{\colorbox{arbiters}{Arbiters} } are \verb$Module$s connecting multiple producers\newline
